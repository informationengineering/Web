        ...
        <main className="main">
          <article className="profile">
            ...
            <div className="info">
              ...
              <button onClick={toggleFavorite} style={{ marginTop: '15px', padding: '10px 20px', borderRadius: '20px', background: isFavorite ? '#ff69b4' : '#ccc', color: 'white', border: 'none', cursor: 'pointer' }}>
                {isFavorite ? '💖 已收藏' : '🤍 加入收藏'}
              </button>

              <div style={{ marginTop: '20px' }}>
                <Link to="/" style={{ textDecoration: 'none', color: '#384aa5' }}>← 返回首頁</Link>
              </div>
              <div style={{ marginTop: '10px' }}>
                <Link to="/favorites" style={{ textDecoration: 'none', color: '#384aa5' }}>💾 我的收藏</Link>
              </div>
            </div>
          </article>
        </main>
